      ...
      <div className='f'>
        <div className='form'>
            ...
            <div className='input-container ic2'>
                <input type='text' placeholder='Fetching Address' />
            </div>
            <button type='text' className='submit'> Fetch </button>
        </div>
        <div className='form'>
            <div className='title'>
                Token Data
            ...
            <button type='text' className='submit'> Refresh </button>
